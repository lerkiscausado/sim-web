...
export function PacienteAvatar({ idPaciente, size = 56 }: PacienteAvatarProps) {
    ...
    return (
        <div
            className="flex shrink-0 items-center justify-center overflow-hidden rounded-md border bg-muted/40"
            style={{ width: size, height: size, borderColor: "var(--border-default)" }}
        >
            {url ? (
