...
import { Search, Plus, Loader2, Pencil, Ban, CheckCircle2, TestTube2 } from "lucide-react";
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/50">
                                <TableHead className="font-bold"><span className="inline-flex items-center gap-1.5"><TestTube2 className="h-3.5 w-3.5" />Nombre</span></TableHead>
